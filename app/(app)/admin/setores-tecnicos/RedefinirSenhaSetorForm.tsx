...
import { redefinirSenhaSetorTecnicoAction } from "@/lib/actions/admin";

export default function RedefinirSenhaSetorForm({ setorTecnicoId }: { setorTecnicoId: string }) {
    ...
    <form
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          try {
            await redefinirSenhaSetorTecnicoAction(setorTecnicoId, formData);
            setAberto(false);
          } catch (err) {
