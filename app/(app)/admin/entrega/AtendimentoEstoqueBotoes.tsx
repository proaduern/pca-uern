...
import { aprovarAtendimentoEstoqueAction, rejeitarAtendimentoEstoqueAction } from "@/lib/actions/estoque";

export default function AtendimentoEstoqueBotoes({ atendimentoId }: { atendimentoId: string }) {
      ...
      <button
        ...
        onClick={() => {
          ...
          startTransition(async () => {
            try {
              await aprovarAtendimentoEstoqueAction(atendimentoId);
            } catch (e) {
      ...
      {mostrarRejeicao && (
        <form
          onSubmit={(e) => {
            ...
            startTransition(async () => {
              try {
                await rejeitarAtendimentoEstoqueAction(atendimentoId, formData);
