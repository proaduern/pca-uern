...
import { redefinirSenhaAcessoEntregaAction } from "@/lib/actions/admin";

export default function RedefinirSenhaEntregaForm({ acessoId }: { acessoId: string }) {
    ...
    <form
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          try {
            await redefinirSenhaAcessoEntregaAction(acessoId, formData);
            setAberto(false);
          } catch (err) {
