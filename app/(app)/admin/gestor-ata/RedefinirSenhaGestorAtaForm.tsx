...
import { redefinirSenhaAcessoGestorAtaAction } from "@/lib/actions/admin";

export default function RedefinirSenhaGestorAtaForm({ acessoId }: { acessoId: string }) {
    ...
    <form
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          try {
            await redefinirSenhaAcessoGestorAtaAction(acessoId, formData);
            setAberto(false);
          } catch (err) {
